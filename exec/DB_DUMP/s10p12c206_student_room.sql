...
CREATE TABLE `student_room` (
  ...
  KEY `FKf5420bxfucsk6d0f51y97m49b` (`room_id`),
  KEY `FK5tw2tovm33y96pk72je04nc3o` (`student_id`),
  CONSTRAINT `FK5tw2tovm33y96pk72je04nc3o` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`),
  CONSTRAINT `FKf5420bxfucsk6d0f51y97m49b` FOREIGN KEY (`room_id`) REFERENCES `room` (`room_id`)
