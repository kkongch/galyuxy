...
// import { MindARScene } from 'mind-ar';
...
const ArtCameraPage = () => {
  ...
  useEffect(() => {
    // const mindarScene = new MindARScene({
    //   container: arSceneRef.current,
    // });

    // // 이미지 추가
    // mindarScene.addImage({
    //   src: Gimage,
    //   width: 0.3, // 이미지의 가로 길이 (미터)
    //   height: 0.3, // 이미지의 세로 길이 (미터)
    //   name: 'your_image_name', // 이미지 이름
    // });
